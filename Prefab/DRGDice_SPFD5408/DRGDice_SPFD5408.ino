/*
   ...
   Preconfigured for SPFD5408 (older) displays in 2.4" Arduino shield form factor
   Touch panel configurations may need to be changed for your display.
   Tested with unbranded display and Simkeim display.

   By Blackbeard Softworks 2022-2025
   ---
   ...
   v1.9 - Removed unnecessary sections
   ...
   On this display you need to modify the library.
   Open SPFD5408_TouchScreen.cpp, and go to line 163
   Change "return TSPoint ..." to "return TSPoint(1023-x, 1023-y, z)"
*/
